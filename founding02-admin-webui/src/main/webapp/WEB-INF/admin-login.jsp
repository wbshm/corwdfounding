...
<div class="container">
    ...
    <form action="admin/do/login.html" method="post" class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" name="userPwd" id="userPwd" placeholder="请输入登录密码" style="margin-top:10px;">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <button class="btn btn-lg btn-success btn-block" href="main.html" type="submit"> 登陆</button>
    </form>
</div>
